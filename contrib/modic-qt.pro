...
RESOURCES += src/qt/modic.qrc src/qt/modic_locale.qrc

TRANSLATIONS += src/qt/locale/modic_bg.ts \
                src/qt/locale/modic_de.ts \
                src/qt/locale/modic_en.ts \
                src/qt/locale/modic_es.ts \
                src/qt/locale/modic_fi.ts \
                src/qt/locale/modic_fr.ts \
                src/qt/locale/modic_it.ts \
                src/qt/locale/modic_ja.ts \
                src/qt/locale/modic_pl.ts \
                src/qt/locale/modic_pt.ts \
                src/qt/locale/modic_ru.ts \
                src/qt/locale/modic_sk.ts \
                src/qt/locale/modic_sv.ts \
                src/qt/locale/modic_vi.ts \
                src/qt/locale/modic_zh_CN.ts \
                src/qt/locale/modic_zh_TW.ts
