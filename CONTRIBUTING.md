Contributing to ModernInvestmentCoin Core
============================

The ModernInvestmentCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ModernInvestmentCoin Core project, and is not to be
confused with overall ModernInvestmentCoin Network Protocol consensus changes.

Whether a pull request is merged into ModernInvestmentCoin Core rests with the project merge
...
Patches that change ModernInvestmentCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ModernInvestmentCoin consensus, it must have been
...
The project leader is the release manager for each ModernInvestmentCoin Core release.
