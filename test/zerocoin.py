...
#   c) node1 mines 32 blocks, so now node 0 has 60001modic, node 1 has 4250modic, node2 has none.
#   d) node0 sends 601 modic to node2, in two transactions (301 modic, then 300 modic).
