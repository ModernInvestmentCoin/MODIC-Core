...
In order to support loading of multiple wallets in modic-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is modic.cpp.
...
Changes to modic.cpp
----------------------
modic.cpp is the entry point into modic-qt, and as such, will require some minor modifications to provide hooks for
