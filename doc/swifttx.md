...
* WebSocket: [https://github.com/ModernInvestmentCoin/insight-api-modic#web-socket-api](https://github.com/ModernInvestmentCoin/insight-api-modic#web-socket-api) 
* API: [https://github.com/ModernInvestmentCoin/insight-api-modic#swifttx-transactions](https://github.com/ModernInvestmentCoin/insight-api-modic#swifttx-transactions) 
...
By default, the ModernInvestmentCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ModernInvestmentCoin Core daemon:
