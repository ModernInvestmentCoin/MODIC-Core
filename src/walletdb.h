...
public:
    ...
    bool WriteZMODICSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZMODICSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZMODICSeed_deprecated(uint256& seed);
    bool EraseZMODICSeed();
    bool EraseZMODICSeed_deprecated();

    bool WriteZMODICCount(const uint32_t& nCount);
    bool ReadZMODICCount(uint32_t& nCount);
