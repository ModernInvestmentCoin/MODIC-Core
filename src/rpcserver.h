...
/**
 * ModernInvestmentCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzmodicseed(const UniValue& params, bool fHelp);
extern UniValue getzmodicseed(const UniValue& params, bool fHelp);
