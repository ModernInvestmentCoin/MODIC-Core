...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ModernInvestmentCoin Core modic-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  modic-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded modic transaction") + "\n" +
                               "  modic-tx [options] -create [commands]   " + _("Create hex-encoded modic transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded modic transaction
