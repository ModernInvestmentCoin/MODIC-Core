...
UniValue mnbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a ModernInvestmentCoin initiative\n"
            "  vote-alias         - Vote on a ModernInvestmentCoin initiative\n"
            "  vote               - Vote on a ModernInvestmentCoin initiative/budget\n"
...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"modic-address\" monthly-payment\n"
            ...
            "5. \"modic-address\":   (string, required) ModernInvestmentCoin address to send payments to\n"
            "6. monthly-payment:  (numeric, required) Monthly payment amount\n"

            "\nResult:\n"
            "\"xxxx\"       (string) proposal fee hash (if successful) or error message (if failed)\n"
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"https://forum.modic.fund/t/test-proposal\" 2 820800 \"Mbyp963o1PWrNaFqAGJHURwva7GmLzu5Dm\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://forum.modic.fund/t/test-proposal\" 2 820800 \"Mbyp963o1PWrNaFqAGJHURwva7GmLzu5Dm\" 500"));
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"modic-address\" monthly-payment \"fee-tx\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"https://forum.modic.fund/t/test-proposal\" 2 820800 \"Mbyp963o1PWrNaFqAGJHURwva7GmLzu5Dm\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://forum.modic.fund/t/test-proposal\" 2 820800 \"Mbyp963o1PWrNaFqAGJHURwva7GmLzu5Dm\" 500"));
...
UniValue getbudgetprojection(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) ModernInvestmentCoin address of payment\n"
