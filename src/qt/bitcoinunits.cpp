...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MODIC);
    unitlist.append(mMODIC);
    unitlist.append(uMODIC);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case MODIC:
        return QString("modic");
    case mMODIC:
        return QString("mmodic");
    case uMODIC:
        return QString::fromUtf8("umodic");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case mMODIC:
            return QString("mMODIC");
        case uMODIC:
            return QString::fromUtf8("μMODIC");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case MODIC:
            return QString("tMODIC");
        case mMODIC:
            return QString("mtMODIC");
        case uMODIC:
            return QString::fromUtf8("μtMODIC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case MODIC:
            return QString("MODIC");
        case mMODIC:
            return QString("Milli-MODIC (1 / 1" THIN_SP_UTF8 "000)");
        case uMODIC:
            return QString("Micro-MODIC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case MODIC:
            return QString("TestMODICs");
        case mMODIC:
            return QString("Milli-TestMODIC (1 / 1" THIN_SP_UTF8 "000)");
        case uMODIC:
            return QString("Micro-TestMODIC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
