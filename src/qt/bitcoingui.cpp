                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ModernInvestmentCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ModernInvestmentCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and modic: URIs)"));
...
//    privacyAction->setStatusTip(tr("Privacy Actions for zMODIC"));
...
//    tabGroup->addAction(proposalAction);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ModernInvestmentCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about ModernInvestmentCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ModernInvestmentCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ModernInvestmentCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ModernInvestmentCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a ModernInvestmentCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ModernInvestmentCoin Core help message to get a list with possible ModernInvestmentCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ModernInvestmentCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ModernInvestmentCoin network", "", count));
}
...
{
    QString strTitle = tr("ModernInvestmentCoin Core"); // default title
    ...
    // Append title to "ModernInvestmentCoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
