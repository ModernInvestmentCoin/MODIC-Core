                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzmodicPathCustom = GetArg("-zmodicbackuppath", "");
    ...
    if(!strzmodicPathCustom.empty()) {
        ui->wallet_customzmodicbackuppath->setText(QString::fromStdString(strzmodicPathCustom));
        ui->wallet_customzmodicbackuppath_label->setVisible(true);
        ui->wallet_customzmodicbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzmodicPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ModernInvestmentCoin RPC console.") + "<br>" +
