 ...
 */
    ...
    typeWidget->addItem(tr("Received Modic from zModic"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zModic"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zModic));
