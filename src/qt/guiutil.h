...
/** Utility functions used by the ModernInvestmentCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ModernInvestmentCoin addresses in monospace font
...
// Parse "modic:" URI into recipient object, return true on successful parsing
