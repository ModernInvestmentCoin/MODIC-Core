...
#ifndef MODICARECHAIN_ZMODICWALLET_H
#define MODICARECHAIN_ZMODICWALLET_H
...
public:
    CzMODICWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZMODIC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZMODIC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //MODICARECHAIN_ZMODICWALLET_H
