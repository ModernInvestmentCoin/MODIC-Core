...
#ifndef MODICARECHAIN_ZMODICTRACKER_H
#define MODICARECHAIN_ZMODICTRACKER_H
...
public:
    CzMODICTracker(std::string strWalletFile);
    ~CzMODICTracker();
...
#endif //MODICARECHAIN_ZMODICTRACKER_H
