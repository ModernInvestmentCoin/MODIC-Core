...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop ModernInvestmentCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "ModernInvestmentCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ModernInvestmentCoin features */
        {"modic", "masternode", &masternode, true, true, false},
        {"modic", "listmasternodes", &listmasternodes, true, true, false},
        {"modic", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"modic", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"modic", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"modic", "getmasternodecount", &getmasternodecount, true, true, false},
        {"modic", "masternodeconnect", &masternodeconnect, true, true, false},
        {"modic", "masternodecurrent", &masternodecurrent, true, true, false},
        {"modic", "masternodedebug", &masternodedebug, true, true, false},
        {"modic", "startmasternode", &startmasternode, true, true, false},
        {"modic", "createmasternodekey", &createmasternodekey, true, true, false},
        {"modic", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"modic", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"modic", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"modic", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"modic", "getmasternodescores", &getmasternodescores, true, true, false},
        {"modic", "mnbudget", &mnbudget, true, true, false},
        {"modic", "preparebudget", &preparebudget, true, true, false},
        {"modic", "submitbudget", &submitbudget, true, true, false},
        {"modic", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"modic", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"modic", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"modic", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"modic", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"modic", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"modic", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"modic", "checkbudgets", &checkbudgets, true, true, false},
        {"modic", "mnsync", &mnsync, true, true, false},
        {"modic", "spork", &spork, true, true, false},
        {"modic", "getpoolinfo", &getpoolinfo, true, true, false},
        {"modic", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"zerocoin", "getzmodicseed", &getzmodicseed, false, false, true},
        {"zerocoin", "setzmodicseed", &setzmodicseed, false, false, true}
...
{
    return "> modic-cli " + methodname + " " + args + "\n";
}
